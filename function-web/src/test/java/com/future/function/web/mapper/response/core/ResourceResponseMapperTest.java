...
public class ResourceResponseMapperTest {
  ...
  private static final DataResponse<FileContentWebResponse>
    ...
    HttpStatus.CREATED, FileContentWebResponse.builder()
      .id(ID)
      .name(NAME)
      .file(Collections.singletonMap(FieldName.FULL, URL_PREFIX + FILE_URL))
      .build());
  ...
  public void setUp() {
    ...
    fileObject.put(FieldName.FULL, URL_PREFIX + FILE_URL);
    fileObject.put(FieldName.THUMBNAIL, URL_PREFIX + THUMBNAIL_URL);
  ...
  public void testGivenFileV2ObjectByConvertingToDataResponseReturnDataResponseObject() {
    ...
    assertThat(
      ResourceResponseMapper.toResourceDataResponse(FILE_V2, URL_PREFIX)).isEqualTo(
      createdDataResponse);
    
    assertThat(ResourceResponseMapper.toResourceDataResponse(
      FILE_V2_NULL_THUMBNAIL, URL_PREFIX)).isEqualTo(CREATED_DATA_RESPONSE_NULL_THUMBNAIL);
  }
