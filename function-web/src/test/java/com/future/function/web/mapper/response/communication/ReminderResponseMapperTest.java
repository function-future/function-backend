...
public class ReminderResponseMapperTest {
  ...
  public void testGivenReminderByCallingToPagingReminderReturnPagingResponse() {
    ...
    PagingResponse<ReminderResponse> response =
      ReminderResponseMapper.toPagingReminderResponse(
        new PageImpl<>(Arrays.asList(REMINDER_1, REMINDER_2),
  ...
  public void testGivenReminderByCallingToSingleReminderReturnDataResponse() {
    ...
    DataResponse<ReminderDetailResponse> response =
      ReminderResponseMapper.toSingleReminderDataResponse(
        REMINDER_1, URL_PREFIX);
    assertThat(response.getData()
                 .getId()).isEqualTo(REMINDER_ID_1);
  }
