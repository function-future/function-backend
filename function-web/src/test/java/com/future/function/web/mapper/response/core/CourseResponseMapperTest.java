...
public class CourseResponseMapperTest {
  ...
  public void setUp() {
    ...
    courseWebResponseWithoutThumbnail = CourseWebResponse.builder()
      .id(ID)
      .title(TITLE)
      .description(DESCRIPTION)
      .material(URL_PREFIX + FILE_URL)
    ...
    retrievedDataResponse = DataResponse.<CourseWebResponse>builder().code(200)
      .status("OK")
      .data(courseWebResponseWithoutThumbnail)
      .build();
  }
  ...
  public void testGivenListOfCoursesByMappingToDataResponseReturnDataResponseObject() {
    ...
    DataResponse<List<CourseWebResponse>> dataResponse =
      CourseResponseMapper.toCoursesDataResponse(
        Collections.singletonList(COURSE), URL_PREFIX);
