...
public class QuestionnaireResponseMapperTest {
  ...
  public void toPagingQuestionnaireDetailResponse() {
    ...
    PagingResponse<QuestionnaireDetailResponse> data =
    ...
    assertThat(data.getData()
                 .get(0)
                 .getTitle()).isEqualTo(QUESTIONNAIRE_TITLE);
    assertThat(data.getData()
                 .get(0)
                 .getDescription()).isEqualTo(QUESTIONNAIRE_DESCRIPTION);
    assertThat(data.getData()
                 .get(0)
                 .getStartDate()).isEqualTo(START_DATE);
    assertThat(data.getData()
                 .get(0)
                 .getDueDate()).isEqualTo(DUE_DATE);
  }

  @Test
  public void toDataResponseQuestionnaireDetailResponse() {

    DataResponse<QuestionnaireDetailResponse> data =
  ...
  public void toPagingQuestionnaireSimpleSummaryResponse() {
    ...
    assertThat(data.getData()
                 .get(0)
                 .getId()).isEqualTo(QUESTIONNAIRE_RESPONSE_SUMMARY_ID);
    assertThat(data.getData()
                 .get(0)
                 .getTitle()).isEqualTo(QUESTIONNAIRE_TITLE);
    assertThat(data.getData()
    ...
    assertThat(data.getData()
                 .get(0)
                 .getScore()).isEqualTo(SCORE.getAverage());
