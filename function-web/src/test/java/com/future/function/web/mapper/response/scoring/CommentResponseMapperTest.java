...
public class CommentResponseMapperTest {
  ...
  public void setUp() throws Exception {
    ...
    author = User.builder()
      ...
      .name("name")
      .build();
    authorWebResponse = AuthorWebResponse.builder()
      .id(USER_ID)
      .name("name")
      .build();
    comment = Comment.builder()
      ...
      .text(COMMENT)
      .build();
    commentWebResponse = CommentWebResponse.builder()
      .id("id")
      .comment(COMMENT)
      .author(authorWebResponse)
      .build();
  }
  ...
  public void toListCommentWebResponse() {
    ...
    PagingResponse<CommentWebResponse> actual =
      CommentResponseMapper.toPagingCommentWebResponse(
        new PageImpl<>(Collections.singletonList(comment), pageable, 1));
    assertThat(actual.getData()).isEqualTo(
      Collections.singletonList(commentWebResponse));
  }

  @Test
  public void toDataCommentWebResponse() {

    DataResponse<CommentWebResponse> actual =
      CommentResponseMapper.toDataCommentWebResponse(HttpStatus.OK, comment);
