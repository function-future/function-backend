...
public class ChatroomRequestMapperTest {
  ...
  private static final List<String> CHATROOM_MEMBERS_1 = Arrays.asList(
    MEMBERS_ID_1, MEMBERS_ID_2);

  private static final List<String> CHATROOM_MEMBERS_2 = Arrays.asList(
    MEMBERS_ID_1, MEMBERS_ID_2, MEMBERS_ID_3);
  ...
  public void testGivenChatroomRequestWith2MembersAndChatroomIdByCallingToChatroomReturnChatroom() {
    ...
    assertThat(chatroom.getMembers()
                 .size()).isEqualTo(CHATROOM_MEMBERS_1.size());
  ...
  public void testGivenChatroomRequestWith3MembersAndChatroomIdByCallingToChatroomReturnChatroom() {
    ...
    assertThat(chatroom.getMembers()
                 .size()).isEqualTo(CHATROOM_MEMBERS_2.size());
