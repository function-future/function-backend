...
public class QuestionResponseMapperTest {
  ...
  public void toQuestionWebResponse() {
    ...
    DataResponse<QuestionWebResponse> actual =
      QuestionResponseMapper.toQuestionWebResponse(question);
  ...
  public void toQuestionWebResponseCreated() {
    ...
    DataResponse<QuestionWebResponse> actual =
      QuestionResponseMapper.toQuestionWebResponse(
        HttpStatus.CREATED, question);
  ...
  public void toQuestionPagingResponse() {
    ...
    PagingResponse<QuestionWebResponse> actual =
      QuestionResponseMapper.toQuestionPagingResponse(questionPage);
