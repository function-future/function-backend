...
public class RoomResponseMapperTest {
  ...
  public void setUp() throws Exception {
    ...
    room = Room.builder()
      ...
      .point(0)
      .build();
    roomWebResponse = RoomWebResponse.builder()
      .assignment(assignmentWebResponse)
      .student(userWebResponse)
      .point(0)
      .build();
    roomWebResponseDataResponse = DataResponse.<RoomWebResponse>builder().data(
      roomWebResponse)
    ...
    paging = Paging.builder()
      ...
      .build();
    roomWebResponsePagingResponse =
      PagingResponse.<RoomWebResponse>builder().data(
        Collections.singletonList(roomWebResponse))
        .code(HttpStatus.OK.value())
        .status(
          ResponseHelper.toProperStatusFormat(HttpStatus.OK.getReasonPhrase()))
        .paging(paging)
  ...
  public void toDataRoomWebResponse() {
    ...
    assertThat(actual.getData()
                 .getAssignment()).isEqualTo(assignmentWebResponse);
    assertThat(actual.getData()
                 .getStudent()).isEqualTo(userWebResponse);
    assertThat(actual.getData()
