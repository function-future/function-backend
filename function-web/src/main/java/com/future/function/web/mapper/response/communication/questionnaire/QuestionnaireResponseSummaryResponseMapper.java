...
public class QuestionnaireResponseSummaryResponseMapper {
  ...
  public static DataResponse<QuestionnaireSummaryDescriptionResponse> toDataResponseQuestionnaireDataSummaryDescription(
    QuestionnaireResponseSummary questionnaireResponseSummary, String urlPrefix
  ) {

    return ResponseHelper.toDataResponse(
      HttpStatus.OK, toQuestionnaireSummaryDescriptionResponse(
        questionnaireResponseSummary, urlPrefix));
  }
  ...
  private static QuestionnaireSummaryDescriptionResponse toQuestionnaireSummaryDescriptionResponse(
    ...
    return QuestionnaireSummaryDescriptionResponse.builder()
      .questionnaireDetail(toQuestionnaireDetailResponse(
        questionnaireResponseSummary.getQuestionnaire()))
      .appraisee(
        toAppraiseeResponse(questionnaireResponseSummary.getAppraisee(),
                            urlPrefix
        ))
      .rating(questionnaireResponseSummary.getScoreSummary()
                .getAverage())
      .build();
  }
  ...
  public static DataResponse<List<QuestionQuestionnaireSummaryResponse>> toDataResponseQuestionQuestionnaireSummaryResponseList(
    List<QuestionResponseSummary> data
  ) {

    return ResponseHelper.toDataResponse(
      HttpStatus.OK, toListQuestionQuestionnaireSummaryResponse(data));
  }

  private static List<QuestionQuestionnaireSummaryResponse> toListQuestionQuestionnaireSummaryResponse(
    List<QuestionResponseSummary> data
  ) {

    return data.stream()
      .map(
        QuestionnaireResponseSummaryResponseMapper::toQuestionQuestionnaireSummaryResponse)
      .collect(Collectors.toList());
  }

  private static QuestionQuestionnaireSummaryResponse toQuestionQuestionnaireSummaryResponse(
    QuestionResponseSummary questionnaireResponseSummary
  ) {

    return QuestionQuestionnaireSummaryResponse.builder()
      .id(questionnaireResponseSummary.getId())
      .question(toQuestionQuestionnaireResponse(
        questionnaireResponseSummary.getQuestion()))
      .score(questionnaireResponseSummary.getScoreSummary()
               .getAverage())
      .build();
  }

  private static QuestionQuestionnaireResponse toQuestionQuestionnaireResponse(
  ...
  public static DataResponse<QuestionQuestionnaireSummaryResponse> toDataResponseQuestionQuestionnaireSummaryResponse(
    QuestionResponseSummary questionnaireResponseSummary
  ) {

    return ResponseHelper.toDataResponse(
      HttpStatus.OK, toQuestionQuestionnaireSummaryResponse(
  ...
  public static DataResponse<List<QuestionAnswerResponse>> toDataResponseQuestionAnswerDetailResponse(
    List<QuestionResponse> questionResponseByQuestionResponseSummary,
    String urlPrefix
  ) {
  ...
  private static List<QuestionAnswerResponse> toQuestionAnswerReponseList(
    List<QuestionResponse> data, String urlPrefix
  ) {
  ...
  private static QuestionAnswerResponse toQuestionAnswerReponse(
    QuestionResponse questionResponse, String urlPrefix
  ) {

    return QuestionAnswerResponse.builder()
      .name(questionResponse.getAppraiser()
              .getName())
