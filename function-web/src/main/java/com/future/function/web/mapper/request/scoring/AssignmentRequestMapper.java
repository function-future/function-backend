...
public class AssignmentRequestMapper {
  ...
  public Assignment toAssignment(
    AssignmentWebRequest request, String batchCode
  ) {

    return toValidatedAssignment(request, batchCode);
  }

  private Assignment toValidatedAssignment(
    AssignmentWebRequest request, String batchCode
  ) {
    ...
    assignment.setBatch(Batch.builder()
                          .code(batchCode)
                          .build());
  ...
  public Assignment toAssignmentWithId(
    String assignmentId, AssignmentWebRequest request, String batchCode
  ) {
  ...
  public CopyAssignmentWebRequest validateCopyAssignmentWebRequest(
