...
public class BatchResponseMapper {
  ...
  public static DataResponse<BatchWebResponse> toBatchDataResponse(Batch batch) {

    return DataResponse.<BatchWebResponse>builder()
  ...
  public static PagingResponse<Long> toBatchesPagingResponse(List<Batch> batches) {

    return PagingResponse.<Long>builder()
        .code(HttpStatus.OK.value())
        .status(HttpStatus.OK.getReasonPhrase())
        .data(batches.stream().map(Batch::getNumber).collect(Collectors.toList()))
        .build();
  }
}
