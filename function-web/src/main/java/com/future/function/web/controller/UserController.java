...
public class UserController {
  ...
  public DataResponse<UserWebResponse> createUser(@RequestParam String data,
      @RequestParam(required = false) MultipartFile image) {

    return UserResponseMapper.toUserDataResponse(userService.createUser(userRequestMapper.toUser(data), image));
  }
  ...
  public DataResponse<UserWebResponse> getUser(@PathVariable String email) {
  ...
  public PagingResponse<UserWebResponse> getUsers(@RequestParam(required = false) String role,
  ...
  public DataResponse<UserWebResponse> updateUser(@RequestParam String data,
      @RequestParam(required = false) MultipartFile image) {

    return UserResponseMapper.toUserDataResponse(userService.updateUser(userRequestMapper.toUser(data), image));
  }
