...
public class LoggingRoomController {
  ...
  public LoggingRoomController(
    LoggingRoomService loggingRoomService, TopicService topicService,
  ...
  public PagingResponse<LoggingRoomWebResponse> getLoggingRoomsByMember(
    ...
    if (search != null && !search.equals("")) {
      return LoggingRoomResponseMapper.toPagingLoggingRoomResponse(
        loggingRoomService.getLoggingRoomsByMemberWithKeyword(search,
                                                              session.getUserId(),
    ...
    return LoggingRoomResponseMapper.toPagingLoggingRoomResponse(
      loggingRoomService.getLoggingRoomsByMember(session.getUserId(),
  ...
  public PagingResponse<TopicWebResponse> getLoggingRoomTopic(
    ...
    return LoggingRoomResponseMapper.toPagingTopicResponse(
      topicService.getTopicByLoggingRoom(loggingRoomId,
  ...
  @PostMapping(value = "/{loggingRoomId}/topics/{topicId}/log-messages",
  ...
  public BaseResponse createLogMessage(
    ...
    @PathVariable
      String topicId,
    @RequestBody
      LogMessageWebRequest logMessageWebRequest
  ) {

    logMessageService.createLogMessage(
      logMessageRequestMapper.toLogMessage(logMessageWebRequest,
                                           session.getUserId(), topicId
      ));

    return ResponseHelper.toBaseResponse(HttpStatus.CREATED);
  }

  @PostMapping(value = "/{loggingRoomId}/topics",
               consumes = MediaType.APPLICATION_JSON_VALUE,
               produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(value = HttpStatus.CREATED)
  public BaseResponse createTopic(
    ...
    @PathVariable
      String loggingRoomId,
    @RequestBody
      TopicWebRequest topicWebRequest
  ) {
  ...
  public BaseResponse createLoggingRoom(
    @WithAnyRole(roles = Role.MENTOR)
      Session session,
    @RequestBody
      LoggingRoomWebRequest loggingRoomWebRequest
  ) {
  ...
  public DataResponse<LoggingRoomWebResponse> updateLoggingRoom(
    ...
    return LoggingRoomResponseMapper.toDataResponseLoggingRoomResponse(
      loggingRoomService.updateLoggingRoom(
        loggingRoomRequestMapper.toLoggingRoom(loggingRoomWebRequest,
                                               loggingRoomId
        )), fileProperties.getUrlPrefix());
  }
