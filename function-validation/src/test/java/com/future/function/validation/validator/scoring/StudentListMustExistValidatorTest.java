...
public class StudentListMustExistValidatorTest {

  private static final String STUDENT_ID = "student-id";

  private StudentListMustExist annotation;
  ...
  @InjectMocks
  private StudentListMustExistValidator validator;
  ...
  @Test
  public void isValid() {
    boolean result = validator.isValid(Collections.singletonList(STUDENT_ID), context);
